...
class CommercialScorer(BasePropertyScorer):
    """
    Scores similarity between two commercial properties.

    Commercial properties are matched primarily using:
        - area
        - property type
        - purpose
        - address/location
    ...
    Bedrooms and bathrooms are deliberately excluded because they
    generally do not represent the identity of a commercial property.
    """
    ...
    WEIGHTS = {
        ...
        "purpose": Decimal("10"),
        "building_size": Decimal("15"),
        "land_size": Decimal("10"),
        "location": Decimal("20"),
        "price": Decimal("10"),
    }
    ...
    def score(self, signals: dict) -> MatchScore:
        ...
        commercial-property MatchScore.
        """
    ...
    def _score_location(self, signals: dict) -> SignalScore:
        """
        Commercial properties are strongly location-dependent.
