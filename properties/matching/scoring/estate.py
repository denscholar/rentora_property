...
class EstateScorer(BasePropertyScorer):
    """
    Scores similarity between two estate-based residential properties.

    Estate properties are treated differently from ordinary houses
    because location, property type, and estate characteristics are
    particularly important when determining whether two listings
    represent the same underlying property.
    """
